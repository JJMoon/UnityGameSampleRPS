...
public class SceneProto : AmSceneBase
{
    ...
    public override void Start ()
    {
        ...
        muiMan = new UIManager (GameObject.Find ("CameraHorizontal").camera, muiIsVertical, GetType().ToString (), 12, 14, 25);
    ...
    public override void Update ()
    {
        ...
        if (Input.GetMouseButton (0)) {
            muiMan.MouseHold (Input.mousePosition);
            string hitName = RayHit();
            muiMan.HitManager (hitName);
        }
